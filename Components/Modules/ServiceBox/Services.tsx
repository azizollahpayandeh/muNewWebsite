...
export default function Services() {
  return (
    <>
      <div
        className="flex mr-[20px] transition-all duration-500 ease-in-out hover:bg-[#251741] flex-col lg:flex-row lg:w-[50vw]  w-[84vw]  lg:h-[130px]  gap-2 shadow-[0px_3px_5px_0px_rgb(165,9,251)] bg-[#151516] rounded-xl text-white lg:justify-around lg:items-center">
        ...
        <div className="w-[92%]  pl-[10px] pb-[10px]">
