...
export default function RescentWork() {
  return (
    <>
      <div className="bg-[#1d2024] rounded-2xl mt-[100px] mb-[130px] ">
        <div className="flex flex-col justify-center items-center ">
          <div className="textTop lg:w-[51vw] w-[84vw] pl-[20px] pt-[80px]">
            <div>
              <Pretitle pretitle="PORTFOLIO" />
            </div>
        ...
        <div className="swiper w-[90%] lg:mt-[100px] mt-[40px] mb-[120px] flex justify-center">
          <Swiper
